...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "CrispClient",
      url: "https://github.com/crisp-im/crisp-sdk-ios/releases/download/3.0.0-beta.3/CrispClient.xcframework.zip",
      checksum: "ffea2721788466baa3136b85bd862dbeb2542ec01350646aa4379b250e3beaf6",
    ),
