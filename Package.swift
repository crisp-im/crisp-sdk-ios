...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "CrispClient",
      url: "https://github.com/crisp-im/crisp-sdk-ios/releases/download/3.0.0-beta.4/CrispClient.xcframework.zip",
      checksum: "85700749f42b821867f8fd9a9a9b50bca1b97855bb82a7cca549e07a3e716328",
    ),
