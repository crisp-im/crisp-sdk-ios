...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "CrispClient",
      url: "https://github.com/crisp-im/crisp-sdk-ios/releases/download/3.0.0/CrispClient.xcframework.zip",
      checksum: "996f8841b639043ad18e67c4fd1eebd36ef81ae964c76531cc70e4d7a179058c",
    ),
