...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "CrispClient",
      url: "https://github.com/crisp-im/crisp-sdk-ios/releases/download/3.0.1/CrispClient.xcframework.zip",
      checksum: "01e63915b9fc3102dd8d077612c08d6d598e295a14d55350653ba3d8a42dd8fb",
    ),
